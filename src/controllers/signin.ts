...
import { BadRequestError, IAuthDocument, isEmail } from '@vineetthutheja/joblancer-shared';
...
export  async function read(req: Request, res: Response):Promise<void> {
    ...
    res.status(StatusCodes.OK).json({ message: 'User SignIn successfully', user: userData, token: userJWT });
